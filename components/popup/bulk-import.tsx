...
export function BulkImport({
  ...
  useEffect(() => {
    if (typeof chrome !== "undefined" && chrome.tabs) {
      ...
      const mockTabs = [
        ...
        {
          id: 3,
          url: "https://example.com/long-page-titles-are-truncated-properly",
          title: "Example Page With A Very Long Title That Should Be Truncated",
        },
      ];
      setTimeout(() => {
        setTabs(mockTabs);
  ...
  const isOverLimit =
    !isPro && remainingQuotas !== null && selectedCount > remainingQuotas;
      ...
      <div className="space-y-3 shrink-0">
        {isOverLimit && (
          <div className="flex items-start gap-2 p-2 bg-red-50 border border-red-100 rounded-md text-red-700">
            ...
            <p className="text-[11px] leading-tight">
              <strong>Limit Reached:</strong> You have {remainingQuotas}{" "}
              captures left today. Try again tomorrow or reduce your selection.
            </p>
          </div>
        )}
        ...
        >
          {isAdding ? (
            ...
            <>
              Save {selectedCount} {selectedCount > 1 ? "Pages" : "Page"} to
              Notebook
            </>
          )}
        </Button>
