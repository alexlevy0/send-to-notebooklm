 ...
 **Dernière mise à jour :** 2026-02-14
 ...
 - [x] Sprint 7 : UX & Landing Page Overhaul (100%) ✅
 - [x] Grand Launch V1.1.1 (100%) ✅
 
 ## ️ Roadmap V1.x (Research OS)
 
 ### 🟢 Actuel : Sprint 8 - Context & Readability (V1.2)
 *Objectif :* Résoudre le "Context Rot" et le "Dirty Data".
 ...
 ### Sprint 9 : Media & Resilience (V1.3)
 ...
 **Sprint 8 - Context & Quality**
 ...
 ### 🚀 Grand Launch V1.1.1 (2026-02-14)
 ...
 - ✅ **V1.1.1 Stable** : Mise à jour avec UX refactorisée et Landing Page modernisée.
 - ✅ **Centralisation Config** : URL store centralisée dans `lib/extension-config.ts`.
 
 ### Sprint 7 (2026-02-13)
 - ✅ **Modernisation Landing Page** : Esthétique Linear/Vercel (Aurora, Parallax, Tilt).
 
 ### Sprint 6.5 (2026-02-12)
 - ✅ **Sélection Globale** : Dialogue de recherche persistant pour le carnet cible.
 - ✅ **Capture Manuelle** : Boutons explicites (Save/Bulk) pour éviter les surprises.
